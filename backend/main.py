...
def _fallback_generate(req: GenerateDocRequest, template: dict) -> dict:
    """Fallback document generation using clause database. Supports Hindi."""

    # Hindi generation
    if req.language == "hindi":
        doc = _generate_hindi_document(req, template)
        hindi_tmpl = HINDI_TEMPLATES.get(req.doc_type) or _get_hindi_default(req.doc_type, template.get("name",""))
        hindi_clauses = [{"title": t, "text": b, "risk": "low"} for t, b in hindi_tmpl["clauses"]]
        return {
            "success": True, "document": doc, "doc_type": req.doc_type,
            "template_name": hindi_tmpl["title"],
            "clauses": hindi_clauses,
            "risks": _analyze_risks(req.doc_type, doc),
            "rag_used": True, "rag_clauses_retrieved": len(hindi_clauses),
...
HINDI_TEMPLATES = {
    "nda": {
        "title": "गोपनीयता समझौता (Non-Disclosure Agreement)",
        "subtitle": "भारतीय अनुबंध अधिनियम, 1872 के अंतर्गत",
        "party1_label": "प्रकटकर्ता पक्ष",
        "party2_label": "प्राप्तकर्ता पक्ष",
        "clauses": [
            ("1. गोपनीय जानकारी की परिभाषा",
             "\"गोपनीय जानकारी\" से तात्पर्य किसी भी डेटा या जानकारी से है, चाहे वह मौखिक हो या लिखित, जो प्रकटकर्ता पक्ष के व्यवसाय, तकनीकी, वित्तीय या परिचालन गतिविधियों से संबंधित हो और जो सामान्य जनता को ज्ञात न हो।"),
            ("2. प्राप्तकर्ता पक्ष के दायित्व",
             "प्राप्तकर्ता पक्ष सहमत है कि: (क) गोपनीय जानकारी को सख्त विश्वास में रखेगा; (ख) किसी तीसरे पक्ष को बिना पूर्व लिखित सहमति के प्रकट नहीं करेगा; (ग) केवल निर्धारित उद्देश्य के लिए उपयोग करेगा।"),
            ("3. अवधि",
             "यह समझौता प्रभावी तिथि से निर्धारित अवधि तक लागू रहेगा। गोपनीयता के दायित्व समझौते की समाप्ति के बाद भी दो (2) वर्षों तक लागू रहेंगे।"),
            ("4. उल्लंघन के परिणाम",
             "इस समझौते के उल्लंघन की स्थिति में, प्रकटकर्ता पक्ष न्यायालय से निषेधाज्ञा (Injunction) एवं क्षतिपूर्ति (Damages) प्राप्त करने का अधिकारी होगा।"),
            ("5. शासी कानून",
             "यह समझौता भारतीय अनुबंध अधिनियम, 1872 के प्रावधानों के अनुसार शासित होगा।"),
        ],
        "signature": "हस्ताक्षर",
        "date_label": "तिथि",
        "place_label": "स्थान",
        "witness": "गवाह",
        "disclaimer": "अस्वीकरण: यह दस्तावेज़ NyayaAI द्वारा सूचनात्मक उद्देश्यों के लिए तैयार किया गया है। निष्पादन से पहले किसी योग्य अधिवक्ता से समीक्षा कराएं।"
    },
    "rental": {
        "title": "किराया / अनुज्ञा और अनुमति समझौता",
        "subtitle": "संपत्ति हस्तांतरण अधिनियम, 1882 के अंतर्गत",
        "party1_label": "मकान मालिक / अनुज्ञाकर्ता",
        "party2_label": "किरायेदार / अनुज्ञाग्राही",
        "clauses": [
            ("1. संपत्ति का विवरण",
             "अनुज्ञाकर्ता एतद्द्वारा अनुज्ञाग्राही को उक्त आवासीय परिसर का उपयोग करने का अधिकार प्रदान करता है। यह समझौता केवल अनुज्ञा (License) है, न कि किरायेदारी अधिकार।"),
            ("2. मासिक किराया और भुगतान",
             "अनुज्ञाग्राही प्रत्येक कैलेंडर माह की 5 तारीख तक मासिक किराया का भुगतान करेगा। 10 दिनों से अधिक विलंब पर 2% प्रतिमाह की दर से ब्याज देय होगा।"),
            ("3. सुरक्षा जमा राशि",
             "अनुज्ञाग्राही वापसी योग्य सुरक्षा जमा राशि का भुगतान करेगा। परिसर खाली करने के 30 दिनों के भीतर जमा राशि वापस की जाएगी, जो किसी भी बकाया या नुकसान की राशि काटकर होगी।"),
            ("4. लॉक-इन अवधि",
             "इस समझौते की एक लॉक-इन अवधि होगी जिसके दौरान कोई भी पक्ष इसे समाप्त नहीं कर सकता। लॉक-इन अवधि के दौरान समझौता तोड़ने पर जमा राशि जब्त होगी।"),
            ("5. रखरखाव",
             "अनुज्ञाग्राही परिसर को साफ-सुथरी और उचित स्थिति में बनाए रखेगा। रु. 1,000/- तक की मामूली मरम्मत का खर्च अनुज्ञाग्राही वहन करेगा।"),
            ("6. नोटिस अवधि",
             "कोई भी पक्ष निर्धारित नोटिस अवधि की लिखित सूचना देकर इस समझौते को समाप्त कर सकता है।"),
        ],
        "signature": "हस्ताक्षर",
        "date_label": "तिथि",
        "place_label": "स्थान",
    ...
    "employment": {
        "title": "रोजगार अनुबंध",
        "subtitle": "भारतीय श्रम कानूनों के अंतर्गत",
        "party1_label": "नियोक्ता (कंपनी)",
        "party2_label": "कर्मचारी",
        "clauses": [
            ("1. नियुक्ति और पदनाम",
             "कर्मचारी को उक्त पद पर नियुक्त किया जाता है। कर्मचारी नियोक्ता के व्यवसाय के लिए अपना पूरा समय, ध्यान और कौशल समर्पित करेगा।"),
            ("2. वेतन और लाभ",
             "कर्मचारी को प्रत्येक माह के अंतिम कार्य दिवस तक मासिक वेतन का भुगतान किया जाएगा। वेतन में मूल वेतन, HRA, विशेष भत्ते और वैधानिक योगदान शामिल हैं।"),
            ("3. परिवीक्षा अवधि",
             "कर्मचारी निर्धारित अवधि तक परिवीक्षा पर रहेगा। इस अवधि के दौरान 7 दिनों की लिखित सूचना देकर रोजगार समाप्त किया जा सकता है।"),
            ("4. बौद्धिक संपदा",
             "रोजगार के दौरान बनाई गई सभी रचनाएं, आविष्कार और कार्य नियोक्ता की संपत्ति होंगे।"),
            ("5. गोपनीयता",
             "कर्मचारी रोजगार के दौरान और उसके बाद दो वर्षों तक नियोक्ता की गोपनीय जानकारी को सुरक्षित रखेगा।"),
            ("6. नोटिस अवधि",
             "कोई भी पक्ष निर्धारित नोटिस अवधि की लिखित सूचना देकर रोजगार समाप्त कर सकता है।"),
        ],
        "signature": "हस्ताक्षर",
        "date_label": "तिथि",
        "place_label": "स्थान",
        "witness": "गवाह",
        "disclaimer": "अस्वीकरण: यह दस्तावेज़ NyayaAI द्वारा सूचनात्मक उद्देश्यों के लिए तैयार किया गया है।"
    },
    "legalnotice": {
        "title": "कानूनी नोटिस",
        "subtitle": "भारतीय अनुबंध अधिनियम, 1872 की धारा 73-74 के अंतर्गत",
        "party1_label": "प्रेषक",
        "party2_label": "प्रापक",
        "clauses": [
            ("1. प्रतिनिधित्व",
             "यह नोटिस मेरे मुवक्किल के निर्देश पर और उनकी ओर से भेजा जा रहा है।"),
            ("2. तथ्य और शिकायत",
             "मेरे मुवक्किल ने आपके साथ एक समझौता किया था। इसके बावजूद आपने अपने दायित्वों का पालन नहीं किया है, जो समझौते का उल्लंघन है।"),
            ("3. कानूनी मांग",
             "आपसे अनुरोध है कि इस नोटिस की प्राप्ति के निर्धारित दिनों के भीतर आवश्यक कार्रवाई करें, अन्यथा मेरे मुवक्किल उचित न्यायालय में कानूनी कार्यवाही करने के लिए बाध्य होंगे।"),
            ("4. खर्चे",
             "मुकदमेबाजी के सभी खर्चे और कानूनी शुल्क आपसे वसूल किए जाएंगे।"),
        ],
        "signature": "हस्ताक्षर",
        "date_label": "तिथि",
        "place_label": "स्थान",
    ...
    "freelance": {
        "title": "स्वतंत्र अनुबंध समझौता (Freelance Agreement)",
        "subtitle": "भारतीय अनुबंध अधिनियम, 1872 के अंतर्गत",
        "party1_label": "ग्राहक",
        "party2_label": "फ्रीलांसर / स्वतंत्र ठेकेदार",
        "clauses": [
            ("1. कार्य का दायरा",
             "फ्रीलांसर निर्धारित परियोजना/कार्य को पूरा करने के लिए सहमत है। दायरे से बाहर के किसी भी अतिरिक्त कार्य के लिए अलग से लिखित समझौता आवश्यक होगा।"),
            ("2. शुल्क और भुगतान",
             "ग्राहक सहमत भुगतान अनुसूची के अनुसार शुल्क का भुगतान करेगा। 15 दिनों के बाद के विलंब पर 2% प्रतिमाह की दर से ब्याज लागू होगा।"),
            ("3. बौद्धिक संपदा",
             "पूर्ण भुगतान प्राप्त होने पर सभी डिलीवरेबल्स ग्राहक की संपत्ति बन जाएंगे। पूर्ण भुगतान से पहले सभी IP अधिकार फ्रीलांसर के पास रहेंगे।"),
            ("4. स्वतंत्र ठेकेदार की स्थिति",
             "फ्रीलांसर एक स्वतंत्र ठेकेदार है, कर्मचारी नहीं। सभी कर दायित्व फ्रीलांसर के होंगे।"),
            ("5. समाप्ति",
             "कोई भी पक्ष 14 दिनों की लिखित सूचना देकर इस समझौते को समाप्त कर सकता है।"),
        ],
        "signature": "हस्ताक्षर",
        "date_label": "तिथि",
        "place_label": "स्थान",
...
# Default Hindi template for document types not in HINDI_TEMPLATES
def _get_hindi_default(doc_type: str, template_name: str) -> dict:
    return {
        "title": f"{template_name} (हिंदी)",
        "subtitle": "भारतीय अनुबंध अधिनियम, 1872 के अंतर्गत",
        "party1_label": "प्रथम पक्ष",
        "party2_label": "द्वितीय पक्ष",
        "clauses": [
            ("1. पक्षकारों का परिचय",
             "यह समझौता उपरोक्त पक्षकारों के बीच भारतीय कानून के अनुसार किया जा रहा है।"),
            ("2. दायित्व और शर्तें",
             "दोनों पक्ष इस समझौते में उल्लिखित शर्तों का पालन करने के लिए सहमत हैं। किसी भी बदलाव के लिए दोनों पक्षों की लिखित सहमति आवश्यक है।"),
            ("3. अवधि",
             "यह समझौता प्रभावी तिथि से निर्धारित अवधि तक लागू रहेगा।"),
            ("4. विवाद समाधान",
             "किसी भी विवाद को मध्यस्थता और सुलह अधिनियम, 1996 के अनुसार सुलझाया जाएगा।"),
            ("5. शासी कानून",
...
def _generate_hindi_document(req, template: dict) -> str:
    """Generate a complete Hindi legal document from templates."""
    f = req.fields
    hindi_tmpl = HINDI_TEMPLATES.get(req.doc_type) or _get_hindi_default(req.doc_type, template.get("name",""))

    party1 = f.get("party1") or f.get("landlord") or f.get("employer") or f.get("client") or f.get("company") or "[प्रथम पक्ष]"
    party2 = f.get("party2") or f.get("tenant") or f.get("employee") or f.get("freelancer") or f.get("vendor") or "[द्वितीय पक्ष]"
    today = datetime.utcnow().strftime("%d %B %Y")

    # Build field details in Hindi
    field_details = ""
    field_hindi_map = {
        "party1": "प्रथम पक्ष", "party2": "द्वितीय पक्ष",
        "landlord": "मकान मालिक", "tenant": "किरायेदार",
        "employer": "नियोक्ता", "employee": "कर्मचारी",
        "client": "ग्राहक", "freelancer": "फ्रीलांसर",
        "property_address": "संपत्ति का पता", "rent": "मासिक किराया",
        "deposit": "सुरक्षा जमा", "duration": "अवधि",
        "lockin": "लॉक-इन अवधि", "notice": "नोटिस अवधि",
        "ctc": "वार्षिक CTC", "designation": "पदनाम",
        "purpose": "उद्देश्य", "penalty": "दंड राशि",
        "fee": "शुल्क", "deadline": "अंतिम तिथि",
        "amount": "राशि", "subject": "विषय",
    }
    for k, v in f.items():
        if v:
            hindi_key = field_hindi_map.get(k, k)
            field_details += f"- {hindi_key}: {v}\n"

    doc = f"""{hindi_tmpl['title']}
{hindi_tmpl['subtitle']}

यह समझौता ("करार") दिनांक {f.get('start_date') or f.get('joining_date') or today} ("प्रभावी तिथि") को निम्नलिखित पक्षों के बीच किया जा रहा है:

{hindi_tmpl['party1_label']}: {party1}
तथा
{hindi_tmpl['party2_label']}: {party2}

चूंकि (WHEREAS), दोनों पक्ष निम्नलिखित नियमों और शर्तों पर सहमत हैं:

विवरण:
{field_details}
"""

    for clause_title, clause_text in hindi_tmpl["clauses"]:
        doc += f"\n{clause_title}\n\n{clause_text}\n"
...
यह समझौता भारत के कानूनों, विशेषतः भारतीय अनुबंध अधिनियम 1872 के अनुसार शासित होगा। किसी भी विवाद के लिए {req.state} के न्यायालयों का अनन्य क्षेत्राधिकार होगा।

संपूर्ण समझौता

यह समझौता पक्षकारों के बीच संपूर्ण करार है और सभी पूर्व चर्चाओं का स्थान लेता है।

इस बात के साक्ष्य में, दोनों पक्षों ने उपरोक्त तिथि को इस समझौते पर हस्ताक्षर किए हैं।

{hindi_tmpl['party1_label']}: {party1}
{hindi_tmpl['signature']}: _________________________
नाम: _________________________
{hindi_tmpl['date_label']}: _________________________
{hindi_tmpl['place_label']}: _________________________
...
{hindi_tmpl['witness']} 1: _________________________    {hindi_tmpl['witness']} 2: _________________________

---
{hindi_tmpl['disclaimer']}"""
...
def export_pdf(doc_id: str):
    ...
    try:
        ...
        font_search_paths = [
            ...
            "C:/Windows/Fonts/mangal.ttf",  # Mangal has Devanagari support
        ]
        ...
        # Detect if document is in Hindi
        is_hindi = any(ord(c) > 0x0900 and ord(c) < 0x097F for c in doc.get("content","")[:100])
        base_font = "UniFont" if (is_hindi and hindi_font_registered) else "Helvetica"
        base_font_bold = "UniFont" if (is_hindi and hindi_font_registered) else "Helvetica-Bold"
